...
export default function ImpulseButton({ onClick, onCompanionOpen }: ImpulseButtonProps) {
  ...
  return (
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-16" style={{ zIndex: 10 }}>
      ...
      >
        ...
        <div
          className="absolute inset-2 rounded-full border border-purple-400/15 animate-pulse"
      ...
      >
        ...
        <span
          ...
          ${meditativeMode ? "text-blue-200 tracking-widest" : ""}
        `}
        >
          IMPULS
        </span>
